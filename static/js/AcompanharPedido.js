function aplicarTema(tema) {
  ...
  document
    .getElementById("btnClaro")
    .classList.toggle("ativo", tema === "claro");
  document
    .getElementById("btnEscuro")
...
document
  .getElementById("btnClaro")
  .addEventListener("click", () => aplicarTema("claro"));
document
  .getElementById("btnEscuro")
  .addEventListener("click", () => aplicarTema("escuro"));
...
const dicionario = {
  ...
  "Ele já foi postado e está com a transportadora.":
    "It has already been posted and is with the carrier.",
  ...
  "Seu pedido chegou. Vamos vinculá-lo?":
    "Your order has arrived. Let's link it?",
};
...
document
  .getElementById("btnNotificacoes")
...
async function carregarStatusPedido() {
  try {
    ...
    if (dados.codigo_rastreio) {
      document.getElementById("codigo-texto").textContent =
