...
// src/adapters/zod.ts
function zodValidator(z) {
  return {
    cpf: (message = "CPF inv\xE1lido") => z.string().refine((value) => cpf_default.isValid(value), { message }),
    cnpj: (message = "CNPJ inv\xE1lido") => z.string().refine((value) => cnpj_default.isValid(value), { message })
  };
}
