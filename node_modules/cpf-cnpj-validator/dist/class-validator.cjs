...
// src/adapters/class-validator.ts
...
function IsCPF(options) {
  return (target, propertyName) => {
    classValidator.registerDecorator({
      ...
      propertyName,
      options: { message: "CPF inv\xE1lido", ...options },
      validator: {
        validate(value) {
          return typeof value === "string" && cpf_default.isValid(value);
        }
      }
    });
  };
}
function IsCNPJ(options) {
  return (target, propertyName) => {
    classValidator.registerDecorator({
      name: "IsCNPJ",
      target: target.constructor,
      propertyName,
      options: { message: "CNPJ inv\xE1lido", ...options },
      validator: {
        validate(value) {
          return typeof value === "string" && cnpj_default.isValid(value);
        }
      }
    });
  };
...
exports.IsCPF = IsCPF;
//# sourceMappingURL=class-validator.cjs.map
//# sourceMappingURL=class-validator.cjs.map