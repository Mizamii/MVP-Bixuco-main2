...
var cpfValidator = () => (control) => {
  const value = control.value;
  return !value || cpf_default.isValid(value) ? null : { cpf: value };
};
var cnpjValidator = () => (control) => {
  const value = control.value;
  return !value || cnpj_default.isValid(value) ? null : { cnpj: value };
};
var AngularValidator = class {
  static cpf = cpfValidator();
  static cnpj = cnpjValidator();
};
